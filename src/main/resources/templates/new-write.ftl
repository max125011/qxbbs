...
<body>
    ...
    <#--<div style="width: 100%">-->
        <#--<div style="display: inline;">-->
            <#--<a><img style="width: 100%;height: 240px;" src="${context.contextPath}/images/logo/banner.jpg"/></a>-->
        <#--</div>-->
    <#--</div>-->
    <div style="width: 100%">
    ...
    <div class="container" style="width: 1020px;">
        <!--写文章的标题-->
        <div>
            <h1 style="text-align: center;">发帖子 &#8211; Writing</h1>
            <div style="width: 100%">
                <form role="form" style="padding-top: 20px">
                    ...
                    <#if user?exists && user.policeId == "admin">
                    <div class="form-group">
                        <label for="leadComment">领导批示</label>
