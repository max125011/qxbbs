...
<head>
    ...
    <title>Writing By ${user.nickname}</title>
    <style type="text/css">
        img.wp-smiley,
        img.emoji {
                ...
                <#--<div class="collapse navbar-collapse">-->
                    <#--<div class="items-wrap">-->
                        <#--<ul class="nav navbar-nav">-->
                            <#--<li><a href="" ><img src="${context.contextPath}/images/user/<#if user.pictureUrl?exists>${user.pictureUrl}<#else>default-1.jpg</#if>" width="32px" height="32px">&nbsp;&nbsp;&nbsp;滴水藏海</a></li>-->
                        <#--</ul>-->
                    <#--</div>-->
                <#--</div>-->
            <#--</nav>-->
...
<div id="primary" class="content-area">
    <div id="main" class="site-main" role="main">
        ...
        <div class="site-branding">
            <h1 class="site-title">写文章 &#8211; Writing</h1>
            <form role="form">
            ...
            <div id="edit-submit">
                <a href="javascript:void (0)" class="alm-load-more-btn  btn load-more" onclick="submit();">提交文章</a>
            </div>
